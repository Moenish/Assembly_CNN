    ...
    .out_loop:
        ...
        .in_loop:
            ...
            .yloop_img:                                                             ; Adott kep/matrix oszlopai
                ...
                ;imul    eax, 8
                add     ebx, 8                  ; Ez mindig kell paddingtol fuggetlenul
                mov     dword [conv_temp], ebx
                pop     ebx
                ;pop     eax
    ...
    .loop:
        ...
        .yloop_img: ; ez jonak tunik                                ; kep sorai
            ...
            pop     ecx
                ...
                mov     al, byte [size] ; 14
                imul    eax, 2          ; 28
                ;add     al, byte [pool_pad] ; 28
                ;add     al, byte [pool_pad] ; 28
                imul    eax, 4
                add     esi, eax                    ; ESI eltolas
                pop     eax
